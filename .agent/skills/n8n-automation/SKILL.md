...
description: Expert guidance for designing, building, validating, and refining n8n workflows using n8n-MCP tools. Use this skill when the user asks to build, test, modify, or debug n8n workflows.
---

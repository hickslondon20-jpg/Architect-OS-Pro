...
description: A system instruction set for creating high-quality Antigravity skills. Use when the user asks to create a new skill or wants to "reference" the Gemini Skill Creator.
---

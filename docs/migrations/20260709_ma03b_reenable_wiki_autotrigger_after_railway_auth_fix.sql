-- MA-03B operational re-enable after Railway Anthropic auth fix.
-- Applied live on 2026-07-09 after the deployed backend's protected
-- Anthropic smoke endpoint returned ok=true.

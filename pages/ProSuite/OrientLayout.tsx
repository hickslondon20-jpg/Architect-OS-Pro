...
const tabs = [
    {
        id: 1,
        label: 'Overview',
        path: '/pro/execution/orient/overview',
        icon: Compass,
    },
    {
        id: 2,
        label: 'Alignment Tools & Resources',
        path: '/pro/execution/orient/alignment',
        icon: ClipboardList,
    },
];

export const OrientLayout: React.FC = () => {
    return (
            ...
            <div className="sticky top-0 z-50 px-4 py-4 sm:px-6 lg:px-10" style={{ background: 'var(--bg-canvas)' }}>
                ...
                >
                    <div>
                        ...
                        <span className="aos-h3">Orient</span>
                    </div>

                    <nav className="flex gap-3 overflow-x-auto" aria-label="Execution orient steps">
                        {tabs.map((tab) => {
                            const Icon = tab.icon;

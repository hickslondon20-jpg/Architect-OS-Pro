...
Reference full template: `/tmp/gsd-install/package/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/tmp/gsd-install/package/.claude/gsd-core/templates/state.md`.

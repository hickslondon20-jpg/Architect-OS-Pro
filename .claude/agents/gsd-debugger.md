...
<required_reading>
@/tmp/gsd-install/package/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/tmp/gsd-install/package/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /tmp/gsd-install/package/.claude
                  → checks /tmp/gsd-install/package/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /tmp/gsd-install/package/.claude/gsd-core
                  → writes to /tmp/gsd-install/package/.claude/gsd-core/hooks/
...
@/tmp/gsd-install/package/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/tmp/gsd-install/package/.claude/gsd-core/references/common-bug-patterns.md

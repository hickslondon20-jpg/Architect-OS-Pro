...
<reference>
@/tmp/gsd-install/package/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/tmp/gsd-install/package/.claude/gsd-core/references/user-profiling.md` to load:

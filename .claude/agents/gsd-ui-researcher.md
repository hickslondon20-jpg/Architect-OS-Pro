...
Use template from `/tmp/gsd-install/package/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/tmp/gsd-install/package/.claude/gsd-core/templates/UI-SPEC.md`

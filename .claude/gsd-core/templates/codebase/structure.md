...
- Usage: Reference from command with `@/tmp/gsd-install/package/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /tmp/gsd-install/package/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /tmp/gsd-install/package/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

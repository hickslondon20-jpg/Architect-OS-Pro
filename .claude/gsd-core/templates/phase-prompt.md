...
<!-- For checkpoint task examples and patterns, see @/tmp/gsd-install/package/.claude/gsd-core/references/checkpoints.md -->
...
See `/tmp/gsd-install/package/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/tmp/gsd-install/package/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/tmp/gsd-install/package/.claude/gsd-core/workflows/verify-phase.md` for verification logic.

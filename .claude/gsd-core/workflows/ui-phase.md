...
```markdown
Read /tmp/gsd-install/package/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /tmp/gsd-install/package/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /tmp/gsd-install/package/.claude/agents/gsd-ui-checker.md for instructions.

...
INSTALL_JS_GLOBAL="/tmp/gsd-install/package/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /tmp/gsd-install/package/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.

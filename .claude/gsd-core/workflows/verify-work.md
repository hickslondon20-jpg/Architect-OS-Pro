...
<template>
@/tmp/gsd-install/package/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/tmp/gsd-install/package/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/tmp/gsd-install/package/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/tmp/gsd-install/package/.claude/gsd-core/workflows/diagnose-issues.md

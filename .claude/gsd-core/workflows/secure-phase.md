...
```
Agent(
  prompt="Read /tmp/gsd-install/package/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/tmp/gsd-install/package/.claude/gsd-core/templates/SECURITY.md`

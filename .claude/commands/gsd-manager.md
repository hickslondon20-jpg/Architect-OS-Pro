...
<execution_context>
@/tmp/gsd-install/package/.claude/gsd-core/workflows/manager.md
...
Read and execute `/tmp/gsd-install/package/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.

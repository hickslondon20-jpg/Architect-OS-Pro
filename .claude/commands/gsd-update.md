...
<execution_context>
@/tmp/gsd-install/package/.claude/gsd-core/workflows/update.md
</execution_context>
...
@/tmp/gsd-install/package/.claude/gsd-core/workflows/sync-skills.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/reapply-patches.md
</execution_context_extended>

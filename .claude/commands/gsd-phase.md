...
<execution_context>
@/tmp/gsd-install/package/.claude/gsd-core/workflows/add-phase.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/insert-phase.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/remove-phase.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/edit-phase.md
</execution_context>

...
<execution_context>
@/tmp/gsd-install/package/.claude/gsd-core/workflows/add-todo.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/note.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/add-backlog.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/plant-seed.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/check-todos.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/list-seeds.md

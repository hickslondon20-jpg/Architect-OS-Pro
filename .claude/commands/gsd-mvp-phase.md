...
<execution_context>
@/tmp/gsd-install/package/.claude/gsd-core/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/tmp/gsd-install/package/.claude/gsd-core/workflows/mvp-phase.md end-to-end.

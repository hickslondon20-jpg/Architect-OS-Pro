...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/tmp/gsd-install/package/.claude/.gsd-surface.json`
(sibling to `/tmp/gsd-install/package/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/tmp/gsd-install/package/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/tmp/gsd-install/package/.claude/skills`).
...
`/tmp/gsd-install/package/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/tmp/gsd-install/package/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/tmp/gsd-install/package/.claude/.gsd-surface.json`
Install profile marker: `/tmp/gsd-install/package/.claude/.gsd-profile`
Skill dirs: `/tmp/gsd-install/package/.claude/skills/gsd-*/`
Engine module: `/tmp/gsd-install/package/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/tmp/gsd-install/package/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>

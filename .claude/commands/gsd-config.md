...
<execution_context>
@/tmp/gsd-install/package/.claude/gsd-core/workflows/settings.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/settings-advanced.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/settings-integrations.md
</execution_context>

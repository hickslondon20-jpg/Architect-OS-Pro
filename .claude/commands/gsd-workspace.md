...
<execution_context>
@/tmp/gsd-install/package/.claude/gsd-core/workflows/new-workspace.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/list-workspaces.md
@/tmp/gsd-install/package/.claude/gsd-core/workflows/remove-workspace.md
